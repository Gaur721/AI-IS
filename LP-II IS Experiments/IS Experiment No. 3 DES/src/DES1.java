...
String textFile = "D://SEM-II_AY_2022-23//LP-II//IS Experiments//IS Experiment No. 3 DES/DemoData.txt";  
//path of the encrypted file that we get as output  
String encryptedData = "D://SEM-II_AY_2022-23//LP-II//IS Experiments//IS Experiment No. 3 DES/encrypteddata.txt";  
//path of the decrypted file that we get as output  
String decryptedData = "D://SEM-II_AY_2022-23//LP-II//IS Experiments//IS Experiment No. 3 DES/decrypteddata.txt";  
try   
{  
